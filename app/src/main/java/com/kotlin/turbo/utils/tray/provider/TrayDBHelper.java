...
public class TrayDBHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "TouchSpritePreferences";

    public static final String INTERNAL_TABLE_NAME = "TouchSpriteInternal";

    public static final String DATABASE_NAME = "touchsprite.db";

    public static final String DATABASE_NAME_NO_BACKUP = "touchsprite_backup.db";
